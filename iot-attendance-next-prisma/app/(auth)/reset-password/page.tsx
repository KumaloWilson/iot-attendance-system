  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm">
        ...
        <form method="post" action="/api/auth/reset-password" className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          <h1 className="text-2xl font-black tracking-tight text-brand-950">Reset password</h1>
          <p className="mt-2 text-sm leading-relaxed text-slate-500">
            Choose a new password for your ZETDC staff account. Minimum 8 characters.
          </p>
